...
INSERT IGNORE INTO `notice` (`notice_id`, `is_top`, `title`, `writer`, `content`, `writer_user_id`, `views`, `created_at`, `updated_at`, `deleted_yn`, `deleted_at`) VALUES
	...
	(46, 1, '[필독] 1월 운영 공지', 'admin', '1월 운영/점검 일정 안내', 1, 12, '2026-01-02 12:57:04', NULL, 'N', NULL),
	(47, 1, '[필독] 장애 대응 프로세스', 'admin', '장애 발생 시 보고/조치 흐름 정리', 1, 33, '2026-01-02 12:57:04', '2026-01-03 19:56:47', 'N', NULL),
	(48, 0, '[공지] 신규 프로젝트 등록 규칙', 'admin', '프로젝트 코드/상태 입력 규칙 안내', 1, 5, '2026-01-02 12:57:04', NULL, 'N', NULL),
	...
	(61, 0, '[공지] 신규 기능 배포', 'admin', '신규 기능 안내', 1, 15, '2026-01-02 12:57:04', NULL, 'N', NULL),
...
-- 테이블 데이터 tech_support_scheduler.project:~20 rows (대략적) 내보내기
...
INSERT IGNORE INTO `support` (`ticket_id`, `support_date`, `project_id`, `project_name`, `support_type`, `status`, `title`, `content`, `created_at`, `updated_at`, `deleted_yn`, `deleted_at`) VALUES
	(1, '2025-12-19', 1, 'OO사 유지보수', '장애지원', '접수', '서버 접속 불가', '오전 10시부터 접속 불가. VPN 확인 및 방화벽 룰 점검 필요.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	(2, '2025-12-19', 1, 'OO사 유지보수', '유지보수', '진행', '로그 적재 지연', '배치 로그가 새벽부터 누락. 스케줄러 상태/디스크 용량 확인.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	(3, '2025-12-20', 2, 'XX사 설치지원', '설치지원', '진행', '초기 설치 진행', '현장 방문 설치 예정. WAS/Tomcat 버전 체크 및 포트 오픈 요청.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	...
	(5, '2025-12-24', 3, 'YY사 장애대응', '장애지원', '접수', 'DB 커넥션 에러', 'HikariCP connection timeout 발생. DB 세션/네트워크 상태 확인.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	(6, '2025-12-24', 3, 'YY사 장애대응', '장애지원', '진행', 'CPU 100% 급등', '특정 프로세스 점유율 상승. 로그 분석 및 재기동 여부 검토.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	(7, '2025-12-30', 19, 'XX사 설치지원', '설치지원', 'OPEN', '운영 반영(수정)', '운영 서버 반영 완료. 서비스 정상 동작 확인 및 인수인계.', '2025-12-29 17:33:27', '2025-12-30 12:48:56', 'N', NULL),
	(8, '2025-12-29', 1, 'OO사 유지보수', '장애지원', '접수', 'API 응답 지연', '오후 2시부터 응답 지연. APM 확인 후 DB 슬로우쿼리 점검.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	(9, '2025-12-29', 1, 'OO사 유지보수', '유지보수', '접수', '백업 실패 알림', '백업 스크립트 실패. 권한/경로 확인 및 재실행 필요.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	(10, '2025-12-31', 4, 'ZZ사 정기점검', '유지보수', '예정', '연말 정기 점검', '연말 점검: 로그 정리/디스크 점검/인증서 만료 체크.', '2025-12-29 17:33:27', '2025-12-29 17:33:27', 'N', NULL),
	(11, '2025-12-30', 1, NULL, '장애지원', 'OPEN', '테스트 티켓', 'DB에서 직접 넣은 테스트 데이터', '2025-12-30 11:19:40', '2025-12-30 11:19:40', 'N', NULL),
	(12, '2025-12-29', 20, NULL, '유지보수', 'OPEN', '테스트', '테스트', '2025-12-30 11:20:16', '2025-12-30 12:34:10', 'Y', '2025-12-30 12:34:10'),
	(13, '2025-12-30', 20, NULL, '유지보수', 'OPEN', '테스트2', '테스트2', '2025-12-30 11:20:46', '2025-12-30 11:20:46', 'N', NULL),
	(14, '2025-12-30', 19, NULL, '유지보수', 'OPEN', '테스트3', '테스트3', '2025-12-30 11:29:24', '2025-12-30 11:29:24', 'N', NULL),
	(15, '2025-12-24', 12, NULL, '설치지원', 'OPEN', 'ㅋㅋ', 'ㅋㅋㅋ', '2025-12-30 11:51:59', '2025-12-30 11:51:59', 'N', NULL),
	(16, '2025-12-01', 19, NULL, '유지보수', 'OPEN', '김영업님의 프로젝트', '당장 경주가서 설치해줘!! ', '2025-12-30 12:11:22', '2025-12-30 12:34:06', 'Y', '2025-12-30 12:34:06'),
	(17, '2026-01-02', 18, NULL, '유지보수', 'OPEN', '신년', '신년', '2026-01-02 12:32:02', '2026-01-02 12:44:46', 'Y', '2026-01-02 12:44:46'),
	...
	(25, '2026-01-07', 40, NULL, '유지보수', 'ON_HOLD', '안정화 작업 보류', '고객 요청으로 일정 재조정', '2026-01-02 12:56:55', '2026-01-02 12:56:55', 'N', NULL),
	...
	(39, '2026-01-02', 40, NULL, '유지보수', 'OPEN', '1234', '1234', '2026-01-02 14:17:20', '2026-01-02 14:17:26', 'Y', '2026-01-02 14:17:26');
...
-- 테이블 데이터 tech_support_scheduler.users:~4 rows (대략적) 내보내기
INSERT IGNORE INTO `users` (`user_id`, `login_id`, `password_hash`, `name`, `role`, `created_at`, `updated_at`, `deleted_yn`) VALUES
	(1, 'admin', '$2a$10$H0OvM3UnvkYAabydXYIslur9uYC9iWHl9JqWalowKIt2yGFgpHTWi', '관리자', 'ROLE_ADMIN', '2025-12-23 11:41:25', '2026-01-02 13:34:21', 'N'),
	...
	(11, 'test', '$2a$10$/SX4ek7vx32U0jNl6jUSH.HCZkQTH4kjOUNW2LuSzfETfuKPU67.K', '홍길순', 'ROLE_ADMIN', '2026-01-03 20:25:57', NULL, 'N');
